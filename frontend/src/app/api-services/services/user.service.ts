...
import { PageReponseUserResponse } from '../models/page-reponse-user-response';
...
export class UserService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  getAllUsers$Response(params?: GetAllUsers$Params, context?: HttpContext): Observable<StrictHttpResponse<PageReponseUserResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  getAllUsers(params?: GetAllUsers$Params, context?: HttpContext): Observable<PageReponseUserResponse> {
    const resp = this.getAllUsers$Response(params, context);
    return resp.pipe(
      map((r: StrictHttpResponse<PageReponseUserResponse>): PageReponseUserResponse => r.body)
    );
  }
